...
const eventsDatabase = [
    { id: 1, title: "مهرجان الربيع الثقافي", date: "2026-04-15", category: "ثقافية", location: "ساحة الجامعة", img: "https://images.unsplash.com/photo-1497032205916-ac775f0649ae?auto=format&fit=crop&w=800&q=80", description: "احتفال بقدوم الربيع مع أمسيات شعرية وفنون شعبية." },
    ...
    { id: 3, title: "ورشة الذكاء الاصطناعي", date: "2026-04-20", category: "علمية", location: "قاعة المؤتمرات", img: "https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=800&q=80", description: "تعلم أساسيات الذكاء الاصطناعي وتطبيقاته." },

    { id: 4, title: "حفل موسيقي طلابي", date: "2026-04-25", category: "ترفيهية", location: "المسرح الكبير", img: "https://images.unsplash.com/photo-1500534314209-a25ddb2bd429?auto=format&fit=crop&w=800&q=80", description: "أمسية موسيقية رائعة مع فرقة الطلاب." },
